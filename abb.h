...
/**
 * Imprime los registros del arbol A en salida estandar de tipo tipo en orden
 * @param A
 * @param tipo
 */
...
/**
 * Guarda las variables, funciones importadas y modulos del arbol
 * en el fichero apuntado por file
 * @param A
 * @param file
 */
